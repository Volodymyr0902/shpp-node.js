...
const port = 5353;
const dbURI =
  "mongodb+srv://admin:todosproject@todo.i2ft2.mongodb.net/Users?retryWrites=true&w=majority&appName=TODO";
const app = express();
...
app.set(
  "views",
  "/Users/volodymyr/Desktop/Ш++/Node/src/primitive-servers/2.4-rest-mongo/views"
);
